...
def runDriver(self):
    ...
    print("AVG Spam Precision: ", (sPrecision/10)*100)
    print("AVG Spam Precision(1-E): ", (1-wErr/10)*100)
    print("AVG Spam Recall: ", (sRecall/10)*100)
    print("AVG wAcc: ", (wAcc/10)*100)
    print("AVG wErr: ", (wErr/10)*100)
    print("AVG wAcc_b: ", (wAcc_b/10)*100)
    print("AVG wErr_b: ", (wErr_b/10)*100)
